<?php
/*
Plugin Name: WP OpenID Server
Plugin URI: http://code.google.com/p/diso/svn/trunk/wp-openid-server/
Description: Implements an OpenID provider as a wordpress plugin. Accounts are based on 
						 Wordpress user accounts
Version: 0.1
Author: Steve Ivy
Author URI: http://redmonk.net/
*/

/*
	ACKNOWLEDGEMENTS:
	
	This plugin is a wrap/port of the phpMyID server by CJ Niemira, and is released under 
...
/*
TODO: profile/sreg information will have to be stored in the user's WP profile/account and configurable via the admin interface.
