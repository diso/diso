...
Add the "Contacts List" widget to your sidebar ("Presentation > Widgets" - works in Wordpress 2.3, or 2.0+ with [Automattic's Widgets plugin](http://automattic.com/code/widgets/)).

## Contacts List Template Tag

Use the <code>cl_blogroll()</code> template tag in your template.

<code>&lt;?php cl\_blogroll(); ?>
